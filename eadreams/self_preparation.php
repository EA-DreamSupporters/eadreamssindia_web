                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xl-8 col-lg-8">
                            <h3 class="title">SELF-PREP: Prep Smarter, Achieve Faster.</h3>
                            <p class="m-b30">SelfPrep provides a streamlined platform for efficient learning. Access meticulously curated YouTube video content, categorized by subject and topic. Optimize your study time with our focused approach.</p>
                            <form method="POST">
                                <div class="form-group">

                                    <select name="subject" class="form-control" id="subject-dropdown"
                                        style="margin-top: 14px;" required>
						...
						if(isset($_POST['search'])){
						  ...
						  ?>
                                <div class="dz-blog style-1 bg-white m-b30 blog-half "
                                    style="border: 1px solid rgba(185, 95, 95, 0.13);">
                                    <div class="dz-media dz-img-effect -video" style="padding: 10px;">

                                        <img class="w-img" src="image/bg.jpg" alt="">
                                        <div class="sidber-video-btn">
                                            <a class="popup-video" href="<?php echo $row3['link1']; ?>"><i
                                    ...
                                    <div class="dz-info" style="border: none;">
                                        ...
                                        <input class="form-control" name="pid" type="hidden"
                                            value="<?php echo $row3['p_id']; ?>" />
                                        <input class="form-control" name="plink" type="hidden"
                                            value="<?php echo $row3['link1']; ?>" />
						  ...
						  ?>
                                <div class="dz-blog style-1 bg-white m-b30 blog-half "
                                    ...
                                    <div class="dz-media dz-img-effect -video" style="padding: 10px;">
                                        ...
                                        <img class="w-img" src="image/bg.jpg" alt="">
                                        <div class="sidber-video-btn">
                                            <a class="popup-video" href="<?php echo $row3['link2']; ?>"><i
                                                    class="fas fa-play"></i></a>
                                        </div>
						  ...
						  ?>
                                <div class="dz-blog style-1 bg-white m-b30 blog-half "
                                    ...
                                    <div class="dz-media dz-img-effect -video" style="padding: 10px;">
                                        ...
                                        <img class="w-img" src="image/bg.jpg" alt="">
                                        <div class="sidber-video-btn">
                                            <a class="popup-video" href="<?php echo $row3['link3']; ?>"><i
                                                    class="fas fa-play"></i></a>
                                        </div>
						  ...
						  ?>
                                <div class="dz-blog style-1 bg-white m-b30 blog-half "
                                    ...
                                    <div class="dz-media dz-img-effect -video" style="padding: 10px;">
                                        ...
                                        <img class="w-img" src="image/bg.jpg" alt="">
                                        <div class="sidber-video-btn">
                                            <a class="popup-video" href="<?php echo $row3['link4']; ?>"><i
                                                    class="fas fa-play"></i></a>
                                        </div>
						  ...
						  ?>
                                <div class="dz-blog style-1 bg-white m-b30 blog-half "
                                    ...
                                    <div class="dz-media dz-img-effect -video" style="padding: 10px;">
                                        ...
                                        <img class="w-img" src="image/bg.jpg" alt="">
                                        <div class="sidber-video-btn">
                                            <a class="popup-video" href="<?php echo $row3['link5']; ?>"><i
                                                    class="fas fa-play"></i></a>
                                        </div>
                            ...
                            <?php
							  ...
							  } else { echo "<p class='dz-title' style='color:red;'>No Records Found</p>" ;}}?>
							  ...
							  ?>
                                        <div class="widget-posts clearfix">
                                            ...
                                            <div class="dz-media" style="width: 100%;">
                                                ...
                                                <img class="w-img" src="image/bg.jpg" alt="">
                                                <div class="sidber-video-btn">
                                                    <a class="popup-video" href="<?php echo $row4['link1']; ?>"><i
                                                            class="fas fa-play"></i></a>
                                                </div>
                                            ...
                                            <div class="dz-info">
                                                <h6 class="title"><a class="cut-text" target="_blank"
                                                        href="<?php echo $row4['link1']; ?>"><?php echo $row4['title1']; ?></a>
                                                </h6>
                                                <div class="dz-meta">
                                                    <ul>
