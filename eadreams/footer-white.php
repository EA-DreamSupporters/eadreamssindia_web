				...
				<div class="row">
					<div class="col-xl-3 col-lg-12">
						<div class="widget widget_about">
							...
							<p class="text">Ezhuga Aramey Dream Supporters LLP is an ED tech business that began to care about the career aspirations of Indian youngsters.</p>
					...
					<div class="col-xl-2 col-lg-3 col-sm-4 col-4">
						<div class="widget widget_services">
							...
							<ul>
								...
								<li><a href="self-preparation">Self Prepartaion</a></li>
