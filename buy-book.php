...
?>
                                                    ...
                                                    <div class="form-check search-content">
                                                        ...
                                                        <a
                                                            href="catwisebook.php?catid=<?php  echo $row['category_id'];?>"><input
...
?>
                                                    <div class="form-check search-content">
                                                        <a
                                                            href="subcatwisebook.php?catid=<?php  echo $row['subcategory_id'];?>"><input
...
$cnt=$cnt+1;
                                    ...
                                    <div class="accordion-item">
                                        <button class="accordion-button" id="heading3" type="button"
                                            ...
                                            aria-controls="collapse3">Shop by Pricing</button>
                                        <div id="collapse3" class="accordion-collapse collapse show accordion-body"
                                            aria-labelledby="heading3" data-bs-parent="#accordionExample">
                                            <div class="row widget dz-widget_services d-flex justify-content-between">
                                                <div class="">

                                                    <div class="form-check search-content">
                                                        <a href="pricewise.php"><input class="form-check-input"
                                                                type="checkbox" value="" id="productCheckBox-01">
                                                            <label class="form-check-label" for="productCheckBox-01">
                                                                Low to High
                                                            </label></a>
                                                    </div>
                                                ...
                                                <div class="">
                                                    ...
                                                    <div class="form-check search-content">
                                                        <a href="pricewisedesc.php"><input class="form-check-input"
                                                                type="checkbox" value="" id="productCheckBox-01">
                                                            <label class="form-check-label" for="productCheckBox-01">
                                                                High to Low
                                                            </label></a>
...
?>
                                <div class="col-book style-2">
                                    <div class="dz-shop-card style-1">
                                        <div class="dz-media">
                                            <a href="book_details.php?id=<?php echo $row1['book_id']; ?>"><img
                                                    src="images/<?php echo $row1['image']; ?>"> </a>
                                        </div>
                                        ...
                                        <div class="dz-content">
                                            <h5 class="title"><a
                                                    href="book_details.php?id=<?php echo $row1['book_id']; ?>"><?php  echo $row1['book'];?></a>
                                            </h5>
                                            <ul class="dz-tags">
                                            ...
                                            <div class="book-footer">
                                                ...
                                                <a href="book_details.php?id=<?php echo $row1['book_id']; ?>"
...
$cnt=$cnt+1;
                            ...
                            <div class="row page mt-0">
                                <div class="col-md-6">
                                    <p class="page-text">Showing
                                        <?php if($per_page_record > $count){ echo $count; }else{  echo $per_page_record;  } ?>
                                        from <?php echo $count; ?> Books</p>
                                </div>
                                <div class="col-md-6">
							...
							if ($i == $page) {   
							$pagLink .= "<li class='page-item'><a class = 'page-link active' href='buy-book.php?page="  
                                                .$i."'>".$i." </a></li>";   
							}               
							else  {   
							$pagLink .= "<li class='page-item'><a class = 'page-link' href='buy-book.php?page=".$i."'>   
																	".$i." </a></li>";     
							}   
							};     
							echo $pagLink;   
